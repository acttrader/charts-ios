...
final class BridgeCommandTests: XCTestCase {
    ...
    func testInitWithComparesIncludesInitialCompares() throws {
        let cmd = BridgeCommand.initialize(
            ...
            showBidAskLines: nil, showAskLine: nil, showBidLine: nil,
            showActLogo: nil, showCandleCountdown: nil,
            ...
            showLtpPrice: nil, priceSourceSelector: nil,
